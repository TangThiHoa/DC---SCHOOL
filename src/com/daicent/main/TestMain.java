...
public class TestMain {
    ...
    public static void main(String[] args) {
        ...
        Subject sb2 = new Subject(2, "Văn",8);
        Subject sb3 = new Subject(3, "Anh",7);

       // Tạo list môn học riêng và add môn vào list riêng
        ...
        //put học sinh và list vừa tạo vào map
        maplist.put(st1, s1);
        maplist.put(st2, s2);
        maplist.put(st3, s3);
        ...
        Student st6 = new Student(6, "Thuận ");

        Subject sb4 = new Subject(1, "Toan",8);
        Subject sb5 = new Subject(2, "Văn", 9);
        Subject sb6 = new Subject(3, "Anh", 9);
        ...
        Clazz cl1 = new Clazz(1, "1A");
        Clazz cl2 = new Clazz(2, "2A");
        ...
        for (Clazz clazz : school.get(a)) {
            System.out.println("class " + clazz.getNameClazz());
    ...
    static double getMathScore(Student a) {
        for (Subject subject : maplist.get(a)) {
            if (subject.getNameSubject() == "Toan") {
